...
```bash
sudo cp scripts/manager/bin/rfc7030-cert-check.sh /usr/local/bin/rfc7030-cert-check
...
sudo cp scripts/manager/systemd/rfc7030.conf.example /etc/rfc7030/.rfc7030
...
```bash
sudo cp scripts/manager/systemd/rfc7030-cert-check.timer /etc/systemd/system/
sudo cp scripts/manager/systemd/rfc7030-cert-check.service /etc/systemd/system/
